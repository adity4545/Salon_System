    ...
    <div className="home">
      <nav className="container --flex-between">
        ...
        <div className="additional-buttons">
          <ul className="home-links" >
            <li>
              ...
              <Link to="" style={{width:"130px"}}>Service</Link></button>
            </li>
            <li>
              <button className="btn btn" style={{background:""}}>
                <Link to="/createBooking" style={{width:"130px"}}>Booking</Link>
              </button>
            </li>
            ...
            <li>
              <button className="btn btn" style={{width:"110px"}}>
                <Link to="/az">Vacancy</Link>
              </button>
            </li>

            <li>
            <button className="btn btn" style={{width:"90px"}}>
        ...
        <ul className="home-links">
          <ShowOnLogout>
            <li>
              <Link to="/register" style={{marginLeft:"-70px"}}>Register</Link>
            </li>
            <li>
              <button className="--btn --btn-primary" style={{marginRight:"70px"}}>
          ...
          <ShowOnLogin>
            <li>
              <button className="btn btn" style={{background:"#b09c7f"}}>
          ...
          <div className="modal-content" style={{color:"red"}}>
            ...
            {selectedProduct.image && (
              <div className="product-image">
                <img
                  src={selectedProduct.image.filePath}
